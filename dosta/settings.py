"""
Django settings for dosta project.
...
SECRET_KEY = 'django-insecure-straz-0c5afu65s-6k7@547z9-y-p8!7)o=^xh0anj&lrb=dpl'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['*']
# CORS (Optional) if frontend and backend are on different domains
...
WSGI_APPLICATION = 'dosta.wsgi.application'
