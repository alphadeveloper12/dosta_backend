...
def populate():
    print("Starting Indian Menu (150 AED) Population...")
    ...
    menu_structure = {
        ...
        "Desserts": [
            ...
            "Exotic Fruit Salad",
            "Rice Pudding with Mango Coulis",
            "Fresh cut fruit",
            "Gulab Jamun"
        ],
        "Hot Beverages": [
    ...
    for course_name, item_names in menu_structure.items():
        ...
        for raw_name in item_names:
            ...
            # NEW: Image sourcing
            source_folder = os.path.join(django.conf.settings.MEDIA_ROOT, 'source_images', 'Indian', '3')
    ...
    menu_name = "Indian Exclusive Menu"
