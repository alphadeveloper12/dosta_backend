...
def populate():
    print("Starting Indian Menu (120 AED) Population...")
    ...
    for course_name, item_names in menu_structure.items():
        ...
        for raw_name in item_names:
            ...
            # NEW: Image sourcing
            source_folder = os.path.join(django.conf.settings.MEDIA_ROOT, 'source_images', 'Indian', '2')
