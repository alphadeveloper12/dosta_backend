...
def populate():
    print("Starting Turkish Menu (145 AED) Population...")
    ...
    menu_structure = {
        "Starters & Appetizers": [
            ("Meze Platter", "A selection of hummus, baba ghanoush, tzatziki, muhammara, and roasted red pepper dip served with warm pita bread."),
            ("Stuffed Grape Leaves (Dolma)", "Vine leaves stuffed with rice, pine nuts, and herbs."),
            ("Fattoush Salad", "Mixed greens with tomatoes, cucumbers, radishes, and crispy pita chips in a lemon-sumac dressing."),
            ("Simit", "Sesame-crusted bread rings served with cheese and olives."),
            ("Cacık", "Yogurt dip with cucumber, garlic, and dill, perfect for dipping.")
        ],
        "Main Courses": [
            ("Lamb Kebab", "Marinated lamb skewers grilled to perfection, served with saffron rice."),
            ("Chicken Shish Kebab", "Tender chicken marinated in spices and grilled on skewers."),
            ("Manti (Turkish Dumplings)", "Dumplings filled with spiced ground meat, served with garlic yogurt and tomato sauce."),
            ("Vegetable Kebab", "Grilled seasonal vegetables marinated with herbs and spices."),
            ("Beef Kofta", "Spiced ground beef patties grilled and served with a tangy tomato sauce."),
            ("Pide (Turkish Pizza)", "Flatbread topped with minced meat, cheese, and herbs.")
        ],
        "Desserts": [
            ("Baklava", "Layers of phyllo pastry filled with nuts and drenched in honey syrup."),
            ("Künefe", "Sweet cheese pastry soaked in syrup and topped with crushed pistachios."),
    ...
    menu_name = "Turkish Exclusive Menu"
