...
def populate():
    print("Starting Asian Menu (145 AED) Population...")
    ...
    menu_structure = {
        ...
        "Live Stations": [
            "Satay",
            "Prawn Satay/ Beef Satay/ Chicken Satay/ Vegetables Satay"
        ],
        "Main Courses": [
    ...
    for course_name, item_names in menu_structure.items():
        ...
        for item_name in item_names:
            ...
            # NEW: Image sourcing
            source_folder = os.path.join(django.conf.settings.MEDIA_ROOT, 'source_images', 'Asian', '2')
    ...
    menu_name = "Asian Exclusive Menu"
