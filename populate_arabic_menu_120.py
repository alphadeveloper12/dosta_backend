...
def populate():
    print("Starting Arabic Menu (120 AED) Population...")
    ...
    menu_structure = {
        ...
        "Live Stations": [
            "Arabic Mix Grill (Shish Tawook, Lamb Kofta)"
        ],
        "Main Courses": [
            "Fish Filet with Provencal Sauce",
            "Chicken Molokieh – Egyptian Style",
            "Lamb Salona with Potato",
            "Eggplant Moussaka",
    ...
    for course_name, item_names in menu_structure.items():
        ...
        for item_name in item_names:
            ...
            # NEW: Image sourcing
            source_folder = os.path.join(django.conf.settings.MEDIA_ROOT, 'source_images', 'Arabic', '1')
